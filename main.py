...
while True:
    ...
    match ch:
        ...
        case 1:
            ...
            match hc:
                case 1:
                    # 1.1 автотранспорт - Создать запись
                ...
                case 2:
                    # 1.2 автотранспорт - Найти запись
                    #запрашиваем у пользователя id искомой учетной записи
                    find_id = view.input_vehicle_id()
                    filter_dat = {'id_vehicle': find_id}
                    status, tbl_dict = com.find_recs_in_table(f_name, filter_dat)
                    if status == True and tbl_dict != []:
                        ...
                        print()
                case 3:
                    # 1.3 автотранспорт - Вывести все записи
                    divider = ' '
                    show_field_names = []
                    ...
                    if status_message == '':
                        ...
                        view.show_table(tbl_list)
                case 4:
                    # 1.4 автотранспорт - Редактировать запись
                    a = 12

                case 5:
                    # 1.5 автотранспорт - Удалить запись
                    # запрашиваем у пользователя id искомой учетной записи
                    delrec_id = view.input_vehicle_id()
                    filter_dat = {'id_vehicle': delrec_id}
                    status, tbl_dict = com.delete_rec_table(f_name, filter_dat)
                    if status == True and tbl_dict != []:
                        print(f'Запись с id = {delrec_id} успешно удалена в таблице автотранспорта.')
                        tbl_list = view.convert_listofdicts_to_listoflists(tbl_dict)
                        view.show_table(tbl_list)
                    else:
                        print('соотвествующие записи не найдены.')
        ...
        case 2:
            ...
            match hc:
                case 1:
                    ...
                    k = p.split()
                    # k=split_list(p)
                    new_rec_dat = {'first_name': k[0], 'family_name': k[1], 'middle_name': k[2],
                                   'birth_date': '20.03.2002', 'phones': '79652364589'}
        ...
        case 3:
            ...
            match hc:
                ...
                case 1:
                    ...
                    new_rec_dat = {'id_vehicle': '2', 'id_personal': '2', 'Description': 'замена_всех_стоек',
                                   'Begin_date': view.input_repairs_start(),
                                   'end_date': view.input_repairs_end(), 'Price': '1000', 'id_status': '1'}
                    field_names = ['id_work', 'id_vehicle', 'id_personal', 'Description', 'Begin_date', 'end_date',
                                   'Price', 'id_status']
                    id_name = 'id_work'
                    com.create_rec_table(f_name, new_rec_dat, field_names, id_name)
                case 2:
        ...
        case 4:
            ...
            match hc:
                case 1:
                    ...
                    field_names = ['id_personal', 'first_name', 'family_name', 'middle_name', 'birth_date', 'phones',
                                   'position']
                    id_name = 'id_personal'
                    com.create_rec_table(f_name, new_rec_dat, field_names, id_name)
                case 2:
